...
<head>
    ...
    <style>
        ...
        /* Status Badges */
        .status { padding: 5px 10px; border-radius: 15px; font-size: 12px; font-weight: 600; text-transform: uppercase; }
        .status.pago { background: #d4edda; color: #155724; }
        .status.pendente { background: #fff3cd; color: #856404; }
        .status.cancelado { background: #f8d7da; color: #721c24; }
        .status.enviado { background: #cce5ff; color: #004085; }
        .status.processando { background: #e2e3e5; color: #383d41; }
        ...
        .btn-detalhes:hover { background-color: #c2185b; }
...
<body>
    ...
    <script>
        function verDetalhesPedido(idPedido) {
            // Aqui você pode implementar um modal com os detalhes do pedido
            alert('Detalhes do Pedido #' + idPedido + '\n\nEsta funcionalidade pode ser expandida para mostrar:\n- Itens do pedido\n- Endereço de entrega\n- Histórico de status\n- Opções de atualização');
            
            // Exemplo de implementação futura:
            // window.location.href = 'detalhes_pedido.php?id=' + idPedido;
        }
    </script>
