...
// Busca apenas os colares no banco de dados
$produtos = getProdutosPorCategoria('colares');
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
<section class="tigre-section">
  <div class="conteudo">
    <h1>COLARES QUE CONTAM HISTÓRIAS</h1>
    <p>Cada detalhe é memória, cada criação é presença.</p>
  </div>

  <div class="imagem-tigre">
    <img src="imgs/gato_colares.png" alt="Gato com Colar">
  </div>
</section>
...
<section class="colecao-section">
  ...
  <div class="colecao-container">
    <?php if (!empty($produtos)): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p style="text-align:center; width: 100%;">Nenhum colar encontrado no momento.</p>
    <?php endif; ?>
  </div>
</section>
