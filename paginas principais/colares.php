...
// === LÓGICA DE PAGINAÇÃO ===
// 1. Pega o número da página da URL
$pagina = isset($_GET['pagina']) ? (int)$_GET['pagina'] : 1;
if ($pagina < 1) $pagina = 1;

// 2. Define limite (8 itens)
$itensPorPagina = 8;

// 3. Chama a função de paginação
if (function_exists('getProdutosPaginados')) {
  $dados = getProdutosPaginados('colares', $pagina, $itensPorPagina);
  $produtos = $dados['produtos'];
  $totalPaginas = $dados['total_paginas'];
} else {
  // Fallback de segurança
  $produtos = getProdutosPorCategoria('colares', 100);
  $totalPaginas = 1;
}
?>
<!DOCTYPE html>
...
<body>
  ...
  <section class="hero-section">
    <video class="video-background" autoplay muted loop playsinline>
      <source src="videos/YARA (2).mp4" type="video/mp4">
