...
// Busca apenas os piercings no banco de dados
$produtos = getProdutosPorCategoria('piercings');
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
/* Texto */
.olhos-section .sobre-text {
  max-width: 420px;
  flex: 1;
  padding-left: 100px;
}

.olhos-section .sobre-text h2 {
  font-size: 38px;
  font-weight: 300;
...
/* Imagem */
.olhos-section .imagem-tigre {
  flex: 1;
  display: flex;
  justify-content: center;
}

.olhos-section .imagem-tigre img {
  max-width: 300px;
  width: 100%;
  height: auto;
  display: block;
...
@media(max-width: 900px){
  .colecao-container { gap: 15px; }
  .produto-card { width: 100%; max-width: 300px; }
  .produto-card img.produto-img { height: 200px; }
}
...
<section class="olhos-section">
  <div class="sobre-text">
    <h2>PIERCINGS QUE EXPRESSAM ATITUDE</h2>
    <p>
      Cada toque revela personalidade, cada escolha é identidade.
    </p>
  </div>
  <div class="imagem-tigre">
    <img src="imgs/olhos_tigre.png" alt="Tigre YARA">
  </div>
</section>
        ...
        <?php foreach ($produtos as $produto): ?>
            <div class="produto-card" onclick="window.location.href='produto_detalhe.php?id=<?php echo $produto['id']; ?>'">
                ...
                <img src="imgs/coracao.png"
                     ...
                     onclick="event.stopPropagation(); curtirProduto(this, <?php echo $produto['id']; ?>)">
                ...
                <button onclick="event.stopPropagation(); adicionarCarrinho(<?php echo $produto['id']; ?>)">
                    Adicionar ao carrinho
                </button>
            </div>
        <?php endforeach; ?>
    <?php else: ?>
        <p style="text-align:center; width: 100%;">Nenhum piercing encontrado no momento.</p>
    <?php endif; ?>
  </div>
</section>
...
// === Lógica Ajax para Carrinho e Favoritos ===
