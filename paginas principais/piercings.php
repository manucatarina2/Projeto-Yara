...
if (function_exists('getProdutosPaginados')) {
  $dados = getProdutosPaginados('piercings', $pagina, $itensPorPagina);
  $produtos = $dados['produtos'];
  $totalPaginas = $dados['total_paginas'];
} else {
  // Fallback
  $produtos = getProdutosPorCategoria('piercings', 100);
  $totalPaginas = 1;
}
?>
<!DOCTYPE html>
...
<body>
  ...
  <section class="olhos-section">
    <div class="sobre-text">
      ...
      <p>Cada toque revela personalidade, cada escolha é identidade.</p>
    </div>
