...
// Busca apenas as pulseiras no banco de dados
$produtos = getProdutosPorCategoria('pulseiras');
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
/* === Seção Tigre (versão harmonizada) === */
.tigre-section {
  display: flex;
  align-items: center;
  justify-content: center;
...
<section class="tigre-section"> 
  ...
  <div class="imagem-tigre"> 
    <img src="imgs/tigrepulseira.png" alt="Tigre"> 
  </div>
</section>
...
<section class="colecao-section" style="padding: 40px 20px;">
  ...
  <div class="colecao-container">
    <?php if (!empty($produtos)): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p style="text-align:center; width: 100%;">Nenhuma pulseira encontrada no momento.</p>
    <?php endif; ?>
  </div>
</section>
